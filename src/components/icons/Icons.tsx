...
export const AppleIcon = ({ className = "", size = 24 }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const TrophyIcon = ({ className = "", size = 24 }: IconProps) => (
  ...
  >
    ...
    <path d="M4 22h16" />
    <path d="M10 14.66V17c0 .55.47.98.97 1.21C11.56 18.75 12 19.5 12 20.5c0 .28-.22.5-.5.5s-.5-.22-.5-.5c0-.5-.44-1.25-1.03-1.79C9.53 17.98 9 17.55 9 17v-2.34" />
    <path d="M14 14.66V17c0 .55-.47.98-.97 1.21C12.44 18.75 12 19.5 12 20.5c0 .28.22.5.5.5s.5-.22.5-.5c0-.5.44-1.25 1.03-1.79C14.47 17.98 15 17.55 15 17v-2.34" />
